      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end justify-between mb-12" id="blog-header-block">
          <div className="md:col-span-7 space-y-4">
            <p className="text-xs font-mono uppercase tracking-widest text-cyan-500 font-bold">DIAVOX KNOWLEDGE PORTAL</p>
            ...
            <p className="text-sm opacity-75 font-light">
              We frequently dissect technical stacks, design conventions, and automation solutions. Search our posts to accelerate your team's knowledge database.
            </p>
          </div>
