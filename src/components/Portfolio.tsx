  ...
  return (
    <section id="portfolio" className={`py-20 md:py-28 text-left ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <h3 className="text-lg font-display font-extrabold group-hover:text-cyan-400 transition-colors">
                    {project.title}
                  </h3>
        ...
        {selectedProject && (
          <div id="project-detail-modal" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            <div className={`w-full max-w-2xl rounded-2xl overflow-hidden border shadow-2xl relative ${
              ...
              <button
                ...
                className="absolute top-4 right-4 z-10 p-2 rounded-xl bg-slate-950/60 dark:bg-slate-800 hover:bg-slate-700/80 transition-colors text-white"
              >
                <X size={15} />
              </button>
              ...
              <div className="p-6 sm:p-8 space-y-5">
                <div className="flex flex-wrap items-center justify-between gap-2 text-xs font-mono opacity-60">
                  <span className="inline-flex items-center space-x-1.5">
                    <Calendar size={13} />
                    <span>Completed: {selectedProject.completion_date}</span>
                  </span>
                  <span>Work type: Remote World wide delivery</span>
                </div>
